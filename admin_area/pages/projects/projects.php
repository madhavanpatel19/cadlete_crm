                ...
                <div style="overflow-x: auto;">
                    <table class="table-premium">
                        ...
                        <tbody id="full-projects-container">
                            ...
                            <tr>
                                <td colspan="8" style="padding: 100px 0; text-align: center;">
...
<script>
    ...
    window.addPhaseRow = function(data = null) {
        ...
        <tr class="budget-phase-row" id="${rowId}" style="transition: 0.3s;" 
            ...
            <td style="padding: 15px 20px; border-bottom: 1px solid #f8fafc; text-align: center; vertical-align: middle; font-weight: 500; color: #64748b; font-size: 12px; white-space: nowrap;">
