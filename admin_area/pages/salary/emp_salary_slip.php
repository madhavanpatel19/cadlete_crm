    ...
    <div id="slip-content" class="salary-slip card" style="margin:10px auto; padding:18px; max-width:820px;">
        ...
        <div class="employee-info clearfix">
            <div class="emp-left">
                ...
                <p><strong>Employee ID:</strong> <?php echo format_emp_id($emp_id); ?></p>
            </div>
            <div class="emp-right">
...
<div class="premium-ui-enabled">
    <div class="page-header-premium">
        <h1><i class="fa fa-money"></i> My Salary Slips</h1>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb" style="background: #f1f5f9; border-radius: 12px; padding: 12px 20px; margin-bottom: 25px;">
                ...
                <li class="active" style="color: #1e293b; font-weight: 600;">Salary Slips</li>
            </ol>
        </div>
    </div>
    <div class="row">
